...
class Payout extends Model
{
    ...
    public function earnings(): BelongsToMany { return $this->belongsToMany(DoctorEarning::class, 'payout_earnings'); }

    public function scopeRequested($q) { return $q->where('status', self::STATUS_REQUESTED); }
