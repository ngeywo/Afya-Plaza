<template>
    <div>
        ...
        <div v-if="store.plan">
            <v-card variant="outlined" class="mb-6 pa-5">
                <div class="d-flex align-center justify-space-between flex-wrap">
                    ...
                    <div class="text-right">
                        ...
                        <div v-if="store.subscription?.effective_amount" class="text-subtitle-1 font-weight-bold">
                            KSh {{ Number(store.subscription.effective_amount).toLocaleString() }}
                        </div>
                    </div>
                </div>
            </v-card>
            ...
            <div class="text-right">
                <v-btn color="error" variant="text" prepend-icon="mdi-close-circle" @click="showCancelDialog = true">Cancel Subscription</v-btn>
            </div>
        </div>
